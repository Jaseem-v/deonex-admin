...
AdminList.getLayout = function getLayout(page: ReactElement) {
...
AdminList.getLayout = function getLayout(page: React.ReactElement) {
  return <Layout>{page}</Layout>;
};
...
export default function AdminList() {
  ...
  const [tableData, setTableData] = useState(_adminList);
  ...
  return (
    <Page >
      ...
      <HeaderBreadcrumbs
          ...
          action={
            <NextLink href={PATH_DASHBOARD.admin.new} passHref>
